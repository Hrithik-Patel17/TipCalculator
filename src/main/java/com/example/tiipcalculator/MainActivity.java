package com.example.tiipcalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enteredAmout = (EditText) findViewById(R.id.Enterbillid);
        seekBar = (SeekBar) findViewById(R.id.seekbarid);
        calculateButton = (Button) findViewById(R.id.tipbtnid);
        totalResultTextView = (TextView) findViewById(R.id.ResultId);
        textViewSeekbar = (TextView) findViewById(R.id.seekbarviewId);
